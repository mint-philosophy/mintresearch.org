(function () {
  ...
  function showSlide(index, options = {}) {
    ...
    document.title = `${name} — Resilience and Adaptation`;
    window.__societalAdaptation.currentSlide = current + 1;
    window.__societalAdaptation.status = 'ready';
