...
function setStatus(state, label) {
  ...
  if (window.__societalAdaptation) window.__societalAdaptation.pretext = state;
...
function applyLayouts(layouts) {
  ...
  if (window.__societalAdaptation) {
    window.__societalAdaptation.layouts = Object.fromEntries(
