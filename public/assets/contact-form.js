// Only opt-in forms use this handler; activate after the endpoint passes a live delivery test.
...
if (form) {
  ...
  status.style.cssText = 'margin:12px 0 0;overflow-wrap:anywhere;color:var(--text-1,inherit)';
  form.querySelector('.ct-body').append(status);
  let sending = false;
